...
public class BrokenRecord extends WALRecord {
    ...
    @Override public int chainSize() {
        return innerRecord.chainSize();
    }

    @Override public WALRecord previous() {
        return innerRecord.previous();
    }

    @Override public WALPointer position() {
        return innerRecord.position();
    }

    @Override public int size() {
        return innerRecord.size();
    }
